...
public class apple_demo extends JFrame implements ActionListener {
	...
	apple_demo() {
		...
		i1 = new ImageIcon(getClass().getResource("/images/apple1.jpg"));
		i2 = new ImageIcon(getClass().getResource("/images/apple2.jpg"));
		i3 = new ImageIcon(getClass().getResource("/images/apple3.jpg"));
		i4 = new ImageIcon(getClass().getResource("/images/apple4.jpg"));
		i5 = new ImageIcon(getClass().getResource("/images/apple5.jfif"));
		i6 = new ImageIcon(getClass().getResource("/images/apple6.jfif"));
