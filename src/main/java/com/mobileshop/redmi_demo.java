...
public class redmi_demo extends JFrame implements ActionListener {
	...
	redmi_demo() {
		...
		i1 = new ImageIcon(getClass().getResource("/images/redmi1.jfif"));

		i2 = new ImageIcon(getClass().getResource("/images/redmi2.jpg"));
		i3 = new ImageIcon(getClass().getResource("/images/redmi3.jpg"));
		i4 = new ImageIcon(getClass().getResource("/images/redmi4.jpg"));
		i5 = new ImageIcon(getClass().getResource("/images/redmi5.jpg"));
		i6 = new ImageIcon(getClass().getResource("/images/redmi6.jpg"));
