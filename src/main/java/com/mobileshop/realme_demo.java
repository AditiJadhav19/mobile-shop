...
public class realme_demo extends JFrame implements ActionListener {
	...
	realme_demo() {
		...
		i1 = new ImageIcon(getClass().getResource("/images/realme.jfif"));
		i2 = new ImageIcon(getClass().getResource("/images/realme2.jfif"));
		i3 = new ImageIcon(getClass().getResource("/images/realme3.jfif"));
		i4 = new ImageIcon(getClass().getResource("/images/realme4.jfif"));
		i5 = new ImageIcon(getClass().getResource("/images/realme5.jpg"));
		i6 = new ImageIcon(getClass().getResource("/images/realme6.jpg"));
